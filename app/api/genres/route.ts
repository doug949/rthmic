...
export const BUILTIN_GENRES = [
  ...
  "Calm Focus|Calm futuristic focus music in the zone of Jon Hopkins and Four Tet. Warm male robotic voice, slightly vocoded. Hypnotic and repetitive like a focus mantra. Minimal house pulse, clean electronic groove, soft synth pads, pulsing bass, restrained percussion. Designed for organising, thinking, and steady forward attention.",
  "Nordic Night|Very slow Scandinavian ambient electronic in the zone of Sigur Ros and Nils Frahm. 70-80 BPM. Positive and reassuring. Soft analog pads, gentle pulsing bass, extremely restrained percussion, almost no drums. No dance energy, no drops, no build-ups. Soft Nordic male vocal, intimate and understated, lightly breathy and conversational, slightly vocoded. Quiet night routine energy.",
  "Sunny Pop|Sunny upbeat 90s and 00s pop in the zone of Len and Smash Mouth. Male vocal, relaxed talk-sung delivery. Bright guitar, funky bass, light drums, handclaps. Big catchy singalong chorus, feel-good hook. Warm, slightly lo-fi, playful, human.",
];
