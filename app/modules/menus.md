...
- Use soft transitions between options.
- Keep verbs clear but non-commanding.
- Let repeated phrases create ease rather than insistence.
- Preserve the user's task meaning while removing pressure.

## CONSTRAINTS
- Do not use "must", "should", or similar obligation language.
